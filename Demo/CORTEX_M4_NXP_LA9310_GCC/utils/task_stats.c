...
/* uiTaskStackSize is not provided by the RFNM tree (NXP defines it elsewhere);
 * stub it — this is debug task-stats output only. */
static uint32_t uiTaskStackSize( TaskHandle_t *pxTaskHandle ) { (void)pxTaskHandle; return 0; }
